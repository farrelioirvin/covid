            ...
            <div class="container-fluid p-3">
                <nav class="navbar navbar-expand-lg ">
                    <a class="navbar-brand" href="#">
                        <span><i class="fas fa-stethoscope fa-2x mx-3"></i>Covid Self-CheckUp</span></a>
                        ...
                        <div class="col-sm">
                            <div class="row">
                                <div class="col-md-5">
                                    ...
                                    <p>
                                        Ketika anda sudah menjadi perawat bekerjalah dengan sungguh-sungguh, karena banyak orang yang terlibat di dalamnya. Keluarga pasien yang dirawat semua bergantung pada kita.
                                    </p>
                                </div>
